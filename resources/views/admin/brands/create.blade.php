...
@section('title', 'Добавить бренд | Mebel Admin')
@section('content')
    ...
    <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
            ...
            <div class="p-3">
                <form method="POST" action="{{ route('admin.brands.store') }}" enctype="multipart/form-data" class="w-full">
                    @csrf
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <input name="name" class="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white-500"
                                   id="grid-first-name" type="text" placeholder="Brand" value="{{ old('name') }}" autofocus>
                            @error('name')

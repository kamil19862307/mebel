...
@section('title', 'Mebel - main')
@section('content')


<!-- banner -->
<div class="bg-cover bg-no-repeat bg-center py-36" style="background-image: url('/storage/images/banner-bg.jpg');">
    <div class="container">
...
<div class="container py-16">
    <div class="w-10/12 grid grid-cols-3 gap-6 mx-auto justify-center">
        <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
            <img src="/storage/images/icons/delivery-van.svg" alt="Delivery" class="w-12 h-12 object-contain">
            <div>
        ...
        <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
            <img src="/storage/images/icons/money-back.svg" alt="Delivery" class="w-12 h-12 object-contain">
            <div>
        ...
        <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
            <img src="/storage/images/icons/service-hours.svg" alt="Delivery" class="w-12 h-12 object-contain">
            <div>
...
<div class="container py-16">
    ...
    <div class="grid grid-cols-3 gap-3">
        <div class="relative rounded-sm overflow-hidden group">
            <img src="/storage/images/category/category-1.jpg" alt="category 1" class="w-full">
            <a href="#"
        ...
        <div class="relative rounded-sm overflow-hidden group">
            <img src="/storage/images/category/category-2.jpg" alt="category 1" class="w-full">
            <a href="#"
        ...
        <div class="relative rounded-sm overflow-hidden group">
            <img src="/storage/images/category/category-3.jpg" alt="category 1" class="w-full">
            <a href="#"
        ...
        <div class="relative rounded-sm overflow-hidden group">
            <img src="/storage/images/category/category-4.jpg" alt="category 1" class="w-full">
            <a href="#"
        ...
        <div class="relative rounded-sm overflow-hidden group">
            <img src="/storage/images/category/category-5.jpg" alt="category 1" class="w-full">
            <a href="#"
        ...
        <div class="relative rounded-sm overflow-hidden group">
            <img src="/storage/images/category/category-6.jpg" alt="category 1" class="w-full">
            <a href="#"
...
<div class="container pb-16">
    ...
    <div class="grid grid-cols-4 gap-6">
        <div class="bg-white shadow rounded overflow-hidden group">
            <div class="relative">
                <img src="/storage/images/products/product1.jpg" alt="product 1" class="w-full">
        ...
        <div class="bg-white shadow rounded overflow-hidden group">
            <div class="relative">
                <img src="/storage/images/products/product4.jpg" alt="product 1" class="w-full">
                <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center
                    justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                    <a href="#"
                       class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition"
        ...
        <div class="bg-white shadow rounded overflow-hidden group">
            <div class="relative">
                <img src="/storage/images/products/product2.jpg" alt="product 1" class="w-full">
                <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center
                    justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                    <a href="#"
                       class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition"
        ...
        <div class="bg-white shadow rounded overflow-hidden group">
            <div class="relative">
                <img src="/storage/images/products/product3.jpg" alt="product 1" class="w-full">
                <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center
                    justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                    <a href="#"
                       class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition"
...
<div class="container pb-16">
    <a href="#">
        <img src="/storage/images/offer.jpg" alt="ads" class="w-full">
    </a>
</div>
<!-- ./ads -->

                    ...
                    @foreach ($brands as $brand)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($brandEditing && $brandEditing->id == $brand->id)
                                    <input wire:model.defer="brandEditing.name" autofocus
                            ...
                            <td class="px-6 py-4 items-center whitespace-nowrap text-right text-sm font-medium">
                                ...
                                @else
                                    ...
                                    <button data-modal='brandToppedModal{{ $brand->id }}'
                                    ...
                                    <div id='brandToppedModal{{ $brand->id }}' class="modal-wrapper">

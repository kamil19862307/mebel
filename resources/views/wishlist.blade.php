    ...
    <div class="container grid grid-cols-12 items-start gap-6 pt-4 pb-16">
        ...
        <div class="col-span-3">
            <div class="px-4 py-3 shadow flex items-center gap-4">
                <div class="flex-shrink-0">
                    <img src="/storage/images/avatar.png" alt="profile"
        ...
        <div class="col-span-9 space-y-4">
            <div class="flex items-center justify-between border gap-6 p-4 border-gray-200 rounded">
                <div class="w-28">
                    <img src="/storage/images/products/product6.jpg" alt="product 6" class="w-full">
                </div>
                <div class="w-1/3">
            ...
            <div class="flex items-center justify-between border gap-6 p-4 border-gray-200 rounded">
                <div class="w-28">
                    <img src="/storage/images/products/product5.jpg" alt="product 6" class="w-full">
                </div>
                <div class="w-1/3">
            ...
            <div class="flex items-center justify-between border gap-6 p-4 border-gray-200 rounded">
                <div class="w-28">
                    <img src="/storage/images/products/product10.jpg" alt="product 6" class="w-full">
                </div>
                <div class="w-1/3">

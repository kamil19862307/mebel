...
@section('content')
    ...
    <div class="container py-4 flex items-center gap-3">
        ...
        <a href="{{ route('products.index') }}" class="text-primary text-base">
    ...
    <div class="container grid grid-cols-2 gap-6">
        <div>
            <img src="/storage/images/products/product1.jpg" alt="product" class="w-full">
            <div class="grid grid-cols-5 gap-4 mt-4">
                <img src="/storage/images/products/product2.jpg" alt="product2"
                     class="w-full cursor-pointer border border-primary">
                <img src="/storage/images/products/product3.jpg" alt="product2" class="w-full cursor-pointer border">
                <img src="/storage/images/products/product4.jpg" alt="product2" class="w-full cursor-pointer border">
                <img src="/storage/images/products/product5.jpg" alt="product2" class="w-full cursor-pointer border">
                <img src="/storage/images/products/product6.jpg" alt="product2" class="w-full cursor-pointer border">
            </div>
        </div>
        ...
        <div>
            ...
            <p class="mt-4 text-gray-600">{{ $product_preview }}</p>
